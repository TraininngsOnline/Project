(function (global, factory) {
    ...
    typeof define === 'function' && define.amd ? define('ngx-stripe', ['exports', '@angular/common', '@angular/core', 'rxjs/operators', 'rxjs'], factory) :
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global['ngx-stripe'] = {}, global.ng.common, global.ng.core, global.rxjs.operators, global.rxjs));
    ...
    ***************************************************************************** */
    ...
    var NgxStripeElementLoadingTemplateDirective = /** @class */ (function () {
        function NgxStripeElementLoadingTemplateDirective(templateRef) {
            this.templateRef = templateRef;
        }
        return NgxStripeElementLoadingTemplateDirective;
    }());
    NgxStripeElementLoadingTemplateDirective.decorators = [
        { type: core.Directive, args: [{
                    selector: '[ngxStripeLoadingTemplate]'
                },] }
    ];
    NgxStripeElementLoadingTemplateDirective.ctorParameters = function () { return [
    ...
    var StripeInstance = /** @class */ (function () {
        ...
        StripeInstance.prototype.confirmPayment = function (options) {
            return this.stripe.pipe(operators.switchMap(function (stripe) { return rxjs.from(stripe.confirmPayment(options)); }), operators.first());
        };
        ...
        StripeInstance.prototype.confirmBoletoPayment = function (clientSecret, data, options) {
            return this.stripe.pipe(operators.switchMap(function (stripe) { return rxjs.from(stripe.confirmBoletoPayment(clientSecret, data, options)); }), operators.first());
        };
        ...
        StripeInstance.prototype.confirmCustomerBalancePayment = function (clientSecret, data, options) {
            return this.stripe.pipe(operators.switchMap(function (stripe) { return rxjs.from(stripe.confirmCustomerBalancePayment(clientSecret, data, options)); }), operators.first());
        };
        ...
        StripeInstance.prototype.confirmPayNowPayment = function (clientSecret, data, options) {
            return this.stripe.pipe(operators.switchMap(function (stripe) { return rxjs.from(stripe.confirmPayNowPayment(clientSecret, data, options)); }), operators.first());
        };
        StripeInstance.prototype.confirmPayPalPayment = function (clientSecret, data) {
            return this.stripe.pipe(operators.switchMap(function (stripe) { return rxjs.from(stripe.confirmPayPalPayment(clientSecret, data)); }), operators.first());
        };
        StripeInstance.prototype.confirmPromptPayPayment = function (clientSecret, data, options) {
            return this.stripe.pipe(operators.switchMap(function (stripe) { return rxjs.from(stripe.confirmPromptPayPayment(clientSecret, data, options)); }), operators.first());
        };
        ...
        StripeInstance.prototype.confirmSetup = function (options) {
            return this.stripe.pipe(operators.switchMap(function (stripe) { return rxjs.from(stripe.confirmSetup(options)); }), operators.first());
        };
        ...
        StripeInstance.prototype.confirmPayPalSetup = function (clientSecret, data) {
            return this.stripe.pipe(operators.switchMap(function (stripe) { return rxjs.from(stripe.confirmPayPalSetup(clientSecret, data)); }), operators.first());
        };
        ...
        StripeInstance.prototype.confirmAffirmPayment = function (clientSecret, data, options) {
            return this.stripe.pipe(operators.switchMap(function (stripe) { return rxjs.from(stripe.confirmAffirmPayment(clientSecret, data, options)); }), operators.first());
        };
    ...
    var StripeService = /** @class */ (function () {
        ...
        StripeService.prototype.confirmPayment = function (options) {
        ...
        StripeService.prototype.confirmBoletoPayment = function (clientSecret, data, options) {
        ...
        StripeService.prototype.confirmCustomerBalancePayment = function (clientSecret, data, options) {
        ...
        StripeService.prototype.confirmPayNowPayment = function (clientSecret, data, options) {
            return this.stripe.confirmPayNowPayment(clientSecret, data, options);
        };
        StripeService.prototype.confirmPayPalPayment = function (clientSecret, data) {
            return this.stripe.confirmPayPalPayment(clientSecret, data);
        };
        StripeService.prototype.confirmPromptPayPayment = function (clientSecret, data, options) {
        ...
        StripeService.prototype.confirmSetup = function (options) {
        ...
        StripeService.prototype.confirmPayPalSetup = function (clientSecret, data) {
        ...
        StripeService.prototype.confirmAffirmPayment = function (clientSecret, data, options) {
    ...
    StripeCardComponent.propDecorators = {
        loadingTemplate: [{ type: core.ContentChild, args: [NgxStripeElementLoadingTemplateDirective, { read: core.TemplateRef },] }],
    ...
    var StripePaymentElementComponent = /** @class */ (function () {
        function StripePaymentElementComponent(stripeElementsService) {
            this.stripeElementsService = stripeElementsService;
        ...
        StripePaymentElementComponent.prototype.ngOnChanges = function (changes) {
            return __awaiter(this, void 0, void 0, function () {
                var options, updateElements, _a;
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        case 0:
                            ...
                            options = this.stripeElementsService.mergeOptions(this.options, this.containerClass);
                            updateElements = false;
                            if (!(changes.elementsOptions || changes.stripe || changes.clientSecret || changes.appearance || !this.elements)) return [3 /*break*/, 2];
                            _a = this;
                            return [4 /*yield*/, this.stripeElementsService
        ...
        StripePaymentElementComponent.prototype.ngOnDestroy = function () {
            if (this.element) {
                this.element.destroy();
            }
        };
        StripePaymentElementComponent.prototype.update = function (options) {
            return this.element.update(options);
        };
        StripePaymentElementComponent.prototype.collapse = function () {
            return this.element.collapse();
        };
        StripePaymentElementComponent.prototype.createElement = function (options) {
            var _this = this;
            if (options === void 0) { options = {}; }
            try {
    ...
    StripePaymentElementComponent.decorators = [
        { type: core.Component, args: [{
                    selector: 'ngx-stripe-payment',
                    template: "<div class=\"field\" #stripeElementRef></div>"
                },] }
    ];
    StripePaymentElementComponent.ctorParameters = function () { return [
        { type: StripeElementsService }
    ]; };
    StripePaymentElementComponent.propDecorators = {
        ...
        clientSecret: [{ type: core.Input }],
        doNotCreateUntilClientSecretIsSet: [{ type: core.Input }],
        load: [{ type: core.Output }],
        blur: [{ type: core.Output }],
        change: [{ type: core.Output }],
        focus: [{ type: core.Output }],
    ...
    exports.NgxStripeElementLoadingTemplateDirective = NgxStripeElementLoadingTemplateDirective;
    ...
    exports.StripePaymentElementComponent = StripePaymentElementComponent;
