...
export class CreateWebinarComponent implements OnInit {
  ...
  getWebinarForm(): FormGroup {
    return this.fb.group({
      ...
      pdtTime: ['', Validators.required],
      edtTime: ['', Validators.required],
      liveOneAttendeePrice: ['', Validators.required],
      livegroupAttendeesPrice: ['', Validators.required],
      recOneAttendeePrice: ['', Validators.required],
      recgroupAttendeesPrice: ['', Validators.required],
      comboOneAttendeePrice: ['', Validators.required],
      combogroupAttendeesPrice: ['', Validators.required],
      disliveOneAttendeePrice: ['', Validators.required],
      dislivegroupAttendeesPrice: ['', Validators.required],
      disrecOneAttendeePrice: ['', Validators.required],
      disrecgroupAttendeesPrice: ['', Validators.required],
      discomboOneAttendeePrice: ['', Validators.required],
      discombogroupAttendeesPrice: ['', Validators.required],
      duration: ['', Validators.required],
      webinarType: ['', Validators.required],
      webinarLink: ['', Validators.required],
      category: ['', Validators.required],
      thumbnailImage: ['', Validators.required],
      authorImage: ['', Validators.required],
      whyShouldAttend: ['', Validators.required],
      benfit: ['', Validators.required],
